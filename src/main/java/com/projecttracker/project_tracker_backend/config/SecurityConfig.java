    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/upload/resume/**", "/uploads/**").permitAll()
                        // Public read of internships
                        .requestMatchers(HttpMethod.GET, "/internships/**").permitAll()
                        // Allow CORS preflight requests
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                        // All other requests require authentication
                        .anyRequest().permitAll() // Allow development flow while populating SecurityContext for authenticated endpoints
                )
